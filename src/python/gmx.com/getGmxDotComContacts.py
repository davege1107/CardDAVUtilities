...
BASE_URL = "https://carddav.gmx.com"
USERNAME = "symnoktg@gmx.com"
PASSWORD = "53H5ZIQA3RS2AKFHLM46"  # Replace with your password or app-specific password

# Directory to save the contacts
OUTPUT_DIR = "./contacts_gmx.com"
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "gmx.com_contacts.vcf")
